    ...
    <main className="min-h-screen bg-gradient-to-br from-black via-[#0a0f18] to-black text-white overflow-hidden">
      <div className="relative container mx-auto px-4 py-20 md:py-32">
        ...
        <div ref={heroRef} className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-white text-opacity-80 mb-8">Etheredrez, Immortalize your victories in NFTs</p>
        ...
        {/* Features section */}
        <div ref={textRef} className="relative z-10 mt-20 md:mt-32 max-w-2xl mx-auto">
          <div className="grid gap-6">
            <Feature title="Stake & Win" description="Stake your crypto in matches. Winners take it all." icon="♔" />
            <Feature
            ...
            <Feature
              ...
              icon={<Image />}
            />
            <Feature title="Tournament" description="Where legends are made and immortalized on-chain" icon="♗" />
          </div>
        </div>
